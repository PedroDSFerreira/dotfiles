...
globalkeys = gears.table.join(
    ...
    -- Layout manipulation
    awful.key({ super, "Control" }, "Right", function () awful.client.swap.byidx(  1)    end,
              {description = "swap with next client by index", group = "client"}),
    awful.key({ super, "Control" }, "Left", function () awful.client.swap.byidx( -1)    end,
              {description = "swap with previous client by index", group = "client"}),
    awful.key({ super, "Control"}, "Tab", function () awful.screen.focus_relative( 1) end,
              {description = "focus the next screen", group = "screen"}),
    awful.key({ super, "Control","Shift"}, "Tab", function () awful.screen.focus_relative(-1) end,
    ...
    awful.key({ super,           }, "Right",     function () awful.tag.incmwfact( 0.05)          end,
              {description = "increase master width factor", group = "layout"}),
    awful.key({ super,           }, "Left",     function () awful.tag.incmwfact(-0.05)          end,
    	  {description = "decrease master width factor", group = "layout"}),

	  awful.key({ super }, "Up", function (c) awful.client.incwfact(0.05, client.focus) end,
    ...
    awful.key({ super,"Shift"}, "Left",     function () awful.tag.incnmaster(-1, nil, true) end,
              {description = "decrease the number of master clients", group = "layout"}),
    awful.key({ super,"Shift"}, "Up",     function () awful.tag.incncol( 1, nil, true)    end,
              {description = "increase the number of columns", group = "layout"}),
    awful.key({ super,"Shift"}, "Down",     function () awful.tag.incncol(-1, nil, true)    end,
    ...
    awful.key({ super }, "r", function() awful.util.spawn_with_shell("sh ~/.config/rofi/launchers/type-6/launcher.sh") end,
    ...
    -- change screen brightness (DOES NOT WORK)
    awful.key({ }, "XF86MonBrightnessUp", function() awful.spawn("xbacklight -inc 10") end),
    awful.key({ }, "XF86MonBrightnessDown", function() awful.spawn("xbacklight -dec 10") end),

    -- Shortcuts for applications
    awful.key({ alt, "Control" }, "v", function() awful.spawn("code") end,
    	{description = "VScode", group = "Shortcuts"}),
    awful.key({ alt, "Control" }, "n", function() awful.spawn("notion-app") end,
    	{description = "Notion", group = "Shortcuts"}),
    awful.key({ alt, "Control" }, "s", function() awful.spawn("spotify") end,
    	{description = "Spotify", group = "Shortcuts"}),
    awful.key({ alt, "Control" }, "b", function() awful.spawn("microsoft-edge-beta") end,
    	{description = "Microsoft Edge", group = "Shortcuts"})
)
