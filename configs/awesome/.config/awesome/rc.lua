...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86MonBrightnessDown", function() awful.spawn("xbacklight -ctrl amdgpu_bl0 -dec 10") end),
    ...
    awful.key({ alt, "Control" }, "b", function() awful.spawn("firefox") end,
    	{description = "Open browser", group = "Shortcuts"}),
