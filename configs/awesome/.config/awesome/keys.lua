...
local KEYS_CONFIG = {
    terminal = os.getenv("TERM") or "wezterm",
...
local function create_awesome_keys()
    return gears.table.join(
        awful.key({ KEYS_CONFIG.modifiers.super }, "s", hotkeys_popup.show_help, 
            { description = "show help", group = "awesome" }),
        awful.key({ KEYS_CONFIG.modifiers.super, "Control" }, "r", awesome.restart, 
            { description = "reload awesome", group = "awesome" }),
        awful.key({ KEYS_CONFIG.modifiers.super, "Shift" }, "q", awesome.quit, 
...
local function create_tag_keys()
    return gears.table.join(
        awful.key({ KEYS_CONFIG.modifiers.super }, "Escape", awful.tag.history.restore, 
...
local function create_screen_keys()
    return gears.table.join(        
        awful.key({ KEYS_CONFIG.modifiers.super, "Control" }, "Tab", function()
...
local function create_application_keys()
    local screenshot_cmd = "scrot --freeze ~/Pictures/Screenshots/%Y-%m-%d_%H-%M-%S.png -s -e 'xclip -selection clipboard -t image/png -i $f'"
...
local function create_client_keys()
    return gears.table.join(
        ...
        awful.key({ KEYS_CONFIG.modifiers.super, "Control" }, "space",
